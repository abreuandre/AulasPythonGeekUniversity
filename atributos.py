...
#Significa, que ao criarmos instâncias/objetos de uma classe, todas as intâncias
...
# todas as intâncias da classe. Ou seja, ao invés de cada instância da classe ter seus próprios
