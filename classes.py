...
Classes podem conter:
    ...
    objeto pode realizar no seu sistema. No caso da lâmpda, por exemplo, um comportamente comum
    que muito provavelmente iríamos querer representar no nosso sistema é o de ligar e desligar a mesma.

Em Python, para definir uma classe utilizamos a palavra reservada class.

OBS: Utilizamos a plalavra 'pass' em Python quando temos um bloco de código que ainda não está
implementado.
